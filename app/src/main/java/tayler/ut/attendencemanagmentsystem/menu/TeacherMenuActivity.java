...
import tayler.ut.attendencemanagmentsystem.fragment.teacher.AddSyllabusFragment;
import tayler.ut.attendencemanagmentsystem.fragment.teacher.MarkAttendenceFragment;
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.nav_view_attendence:
                ...
                break;
            case R.id.nav_add_syllabus:
                fragmentClass = AddSyllabusFragment.class;
                break;
            case R.id.nav_mark_attendence:
                fragmentClass = MarkAttendenceFragment.class;
                break;
