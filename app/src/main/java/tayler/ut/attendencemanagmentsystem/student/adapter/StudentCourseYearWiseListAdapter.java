...
public class StudentCourseYearWiseListAdapter extends RecyclerView.Adapter<StudentCourseYearWiseListAdapter.ViewHolder> {
    ...
    public StudentCourseYearWiseListAdapter(Context context, ArrayList<CourseData> data, ItemClickListener mClickListener) {
